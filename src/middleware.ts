...
export const config = {
  // Everything except the API, the back office, the per-tenant theme page, and
  // Next's own assets. /preview/<slug> is a link handed to one client and is not
  // localised — without this it would be redirected to /fr/preview/<slug>.
