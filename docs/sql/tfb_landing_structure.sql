-- Structure complète de la base `tfb_landing` (12 tables), générée depuis
-- prisma/schema.prisma par :
--
--   npx prisma migrate diff --from-empty --to-schema-datamodel prisma/schema.prisma --script
--
-- À n'utiliser QUE si Prisma ne peut pas joindre la base (hébergement mutualisé,
-- accès uniquement par phpMyAdmin). La voie normale reste `npx prisma migrate deploy`,
-- qui pose en plus la table `_prisma_migrations` et permet les migrations suivantes.
--
-- Import :
--   mysql -u <user> -p tfb_landing < docs/sql/tfb_landing_structure.sql
--
-- La base doit exister au préalable, en utf8mb4 :
--   CREATE DATABASE tfb_landing CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
--
-- Ce fichier ne contient AUCUNE donnée. Le contenu vient ensuite de `npm run seed`
-- puis de `npm run sync:modules`.
...
CREATE TABLE `tfb_module_screenshots` (
    ...
    INDEX `tfb_module_screenshots_feature_id_idx`(`feature_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
